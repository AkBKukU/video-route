...
![Demo full custom configuration](doc/demo.png)
...
This would look like [this example file](doc/examples/rt4k.json) when done and would produce a page that looks like the following:

![Demo RT4K with buttons](doc/rt4k-simple.png)
